  ...
  return (
    <div className="w-full h-full flex-1 flex flex-col">
      ...
      <div className="flex flex-col -translate-y-[200px] gap-8">
            ...
            <div className="md:w-full h-fit md:h-[245px] text-[#010b13] md:text-base lg:text-lg text-justify">
              <div className="flex flex-col items-center md:items-start h-full">
                ...
                <div className="text-xl flex flex-col w-[90%] max-w-[500px] mt-2 md:max-w-none">
                  <span className="font-medium mr-2 text-base">Summary: </span>
                  <p className="md:line-clamp-5">{detail?.overview}</p>
                </div>
                <div className="text-base w-[90%] mt-auto">
        ...
        {/* CAST */}
        <div className="pt-4 md:px-[10%] w-[1000px] md:w-full flex flex-col">
          <h1 className="text-2xl font-semibold">
            Cast <span className="text-sm">(Top 5)</span>
          </h1>
          <div className="relative mt-4 grid lg:grid-cols-6 md:grid-cols-3 w-full gap-3">
            {credit?.cast?.slice(0, 6).map((cast, index) => (
              <div
                key={index}
